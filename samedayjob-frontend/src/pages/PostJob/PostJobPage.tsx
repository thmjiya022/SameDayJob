...
const PostJobPage = ({ user }: PostJobPageProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { title, description, budget, location, categoryID } = formData;
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-end gap-4 pt-4">
                <button
                  ...
                  className="px-6 py-2 bg-gray-300 text-gray-800 rounded hover:bg-gray-400 disabled:opacity-50 transition-colors"
                >
                  Cancel
                </button>
                <button
